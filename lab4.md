...
Keys Pressed: In this step, I entered `ssh cs15lfa23jg@ieng6.ucsd.edu` then pressed `<enter>`. This successully logged me into ieng6 wihtout using a password since my ssh key bypassed the login. 
